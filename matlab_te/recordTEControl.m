...
time = 0;
count = 2;
%conResults = [[0, getInputsFromController(control(1)), getLastOutputsFromController(control(1))]];

conTimeVec = [0];
conUVec    = getInputsFromController(control(1))';
conYVec    = getLastOutputsFromController(control(1));
